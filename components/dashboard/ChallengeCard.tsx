      ...
      >
        ...
        <div className="flex items-center gap-3 mb-3">
          <div className="w-10 h-10 rounded-full bg-primary/20 flex items-center justify-center border border-primary/30">
            <span className="material-symbols-outlined text-primary text-lg">camping</span>
          </div>
          <div>
            <h5 className="text-xs font-bold text-foreground uppercase tracking-tight">{t.challengeTitle}</h5>
            <p className="text-[9px] text-primary/80">{t.skillChallenge}</p>
          </div>
        </div>

        <p className="text-[10px] text-muted-foreground leading-relaxed mb-4">{t.challengeDesc}</p>
