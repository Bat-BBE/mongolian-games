...
export function StationPopup({ station, onClose, onPlay, loreLabel, minigameLabel }: StationPopupProps) {
  ...
  return (
    <div
      className={cn(
        "absolute bottom-6 left-1/2 -translate-x-1/2 z-40 w-[480px] glass rounded-3xl border border-primary/30 p-6",
    ...
    >
      ...
      <div className="flex gap-5 items-start">
        <div
          className="w-20 h-20 rounded-2xl flex items-center justify-center flex-shrink-0 border border-primary/20"
