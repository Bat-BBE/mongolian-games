// ============================================================
// sceneHelpers.ts
// Монголын газарзүйд нийцсэн terrain height функц.
//
// Гол зарчим:
//   - Нийт газрын 70%+ нь ТАЛ (h < 4) байх ёстой
//   - Уулын нуруу зөвхөн баруун болон хойд захад
//   - Говийн тал өмнөд хэсэгт маш хавтгай
//   - Зүүн монгол маш хавтгай
// ============================================================
