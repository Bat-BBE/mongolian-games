...
export function shagaiGuessRulesStrings(
  ...
  if (lang === "mn") {
    return {
      ...
      intro:
        "Хоёр тал атгасан шагайн нийт тоог таана. Зөв таасан тал шагай авна.",
      steps: [
        {
          n: "①",
          t: "Нууц атгалт",
          d: "Өөрийн овооноос 0-с үлдсэн хүртэл атгана",
        },
        {
          n: "②",
          t: "Нийт тоо таах",
        ...
        },
        {
          n: "④",
          t: "Ялагч",
          d: `Бүх ${TOTAL_SHAGAI} шагайг цуглуулсан тал тоглолтод ялна`,
        },
      ],
      scoringTitle: "РАУНДЫН ҮР ДҮН",
      scoringRows: [
        { label: "Зөвхөн та зөв таавал", pts: "Таны тал +нийлбэр" },
        { label: "Зөвхөн нөгөө тал зөв", pts: "Тэдний тал +нийлбэр" },
