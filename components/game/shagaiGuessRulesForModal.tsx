...
import { shagaiGuessRulesStrings } from "./shagaiGuessRulesCopy";
import {
  GAME_TEXT_BODY,
  GAME_TEXT_META,
...
export function ShagaiGuessRulesForModal({ isMn }: { isMn: boolean }) {
  const s = shagaiGuessRulesStrings(isMn ? "mn" : "en");
  return (
